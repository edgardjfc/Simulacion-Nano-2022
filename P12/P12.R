...
png("P12_violin.png", width=15, height=15, units="cm", res=1200)
gr = ggplot(df1, aes(x= Etiquetas, y= value))+ geom_violin(fill="blue", color="red", lwd=0.2)
gr + geom_boxplot(width=0.4, fill="green", color="black", lwd=0.2, outlier.size = 0.6)+ labs(x="Probabilities (n,g,b)", y= "F-score") +
